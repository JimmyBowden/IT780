...
rec = recommender(users)
rec.computeDeviations()
#print(users)
slopeRec = rec.slopeOneRecommendations(users["Ben"])
print("")
print("Initial Test for Users test data:")
print(slopeRec)
#End of initial Test
...
largeRec = recommender(myDict)
largeRec.computeDeviations()
largeSlopeRec = largeRec.slopeOneRecommendations(myDict[myInput])
print("")
print("Test for C4 Data")
print(largeSlopeRec)
